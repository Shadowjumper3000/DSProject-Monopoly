...
class Player:
    ...
    def __init__(self, name, color, initial_balance=1500):
        """
        Initializes a Player object with specified attributes.
        :param name: The name of the player.
        :param color: The player's chosen token color.
        :param initial_balance: The starting balance of the player (default is 1500).
        """
        self.name = name
        self.color = color
